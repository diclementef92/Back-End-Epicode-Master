...
public class PrenotazioneController {
	...
	@PutMapping
	public ResponseEntity<?> modificaPrenotazione(@RequestBody Prenotazione p) {

		try {
			return new ResponseEntity<Prenotazione>(prenotazioneService.updatePrenotazione(p), HttpStatus.OK);
		} catch (Exception e) {
			return new ResponseEntity<String>(e.getMessage(), HttpStatus.NOT_MODIFIED);
		}
	}
